...
<head>
    ...
    <title>Sign Up | Kuba Crypto</title>
    ...
    <link rel="stylesheet" href="css/plugins/notification.min.css" />
...
<body>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-8">
                            <div class="mil-banner-text mil-text-center">
                                <div class="mil-text-m mil-mb-20">Signup</div>
                                <h1 class="mil-mb-60">Get started with Kuba</h1>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-5">
                            <form id="register-form">
                                ...
                                <input class="mil-input mil-up mil-mb-15" type="email" id="email" placeholder="Your e-mail">
                                <p>This is email error</p>

                                <input class="mil-input mil-up mil-mb-15" type="password" id="password" placeholder="Password">

                                <input class="mil-input mil-up mil-mb-30" type="password" id="confirm-password" placeholder="Confirm Password">

                                <div class="mil-up mil-mb-30">
                                    <button type="submit" class="mil-btn mil-md mil-fw">Create Account</button>
                                </div>
                                <p class="mil-text-xs mil-soft">By registering, you agree to our <a href="#." class="mil-accent">Terms and Conditions</a>. Your information is protected and will never be shared with third parties</p>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script src="js/plugins/notification.js"></script>
